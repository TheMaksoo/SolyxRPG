...
class RecipeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $recipes = [
            ...
            // gold_cost now mirrors the equivalent-tier weapon fee (common ~300, iron ~700, silver ~6200,
            // gold ~18200, mythril ~46300) — these had none at all, so a Stone Pickaxe (40 gold of stone)
            // was craftable for 1/25th its own 1000-gold shop price. Weapons/armor got their fee bumped a
            // pass ago (see the comment above); tools were the one category left untouched.
