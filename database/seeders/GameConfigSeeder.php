...
class GameConfigSeeder extends Seeder
{
    public function run(): void
    {
        $config = [
            ...
            'auto_battle_gem_cost_15' => '50',
            'auto_battle_gem_cost_30' => '70',
            'auto_battle_gem_cost_60' => '100',
            'auto_gather_gem_cost_15' => '50',
            'auto_gather_gem_cost_30' => '70',
            'auto_gather_gem_cost_60' => '100',
