...
class MonsterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $monsters = [
            ...
            ['key' => 'sand_reaver', 'name' => 'Sand Reaver', 'glyph' => '🦂', 'hp' => 4200, 'atk' => 260, 'gold' => 1900, 'xp' => 6200, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('crimson_wastes'), 'min_level' => 150, 'enabled' => true, 'skills_json' => self::normalKit('Venomous Sting', 1.6)],
            ['key' => 'dust_wraith', 'name' => 'Dust Wraith', 'glyph' => '🌪', 'hp' => 5100, 'atk' => 300, 'gold' => 2300, 'xp' => 7600, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('crimson_wastes'), 'min_level' => 167, 'enabled' => true, 'skills_json' => self::normalKit('Sand Vortex', 0.6, 3)],
            ['key' => 'bone_colossus', 'name' => 'Bone Colossus', 'glyph' => '🦴', 'hp' => 6000, 'atk' => 340, 'gold' => 2750, 'xp' => 9200, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('crimson_wastes'), 'min_level' => 183, 'enabled' => true, 'skills_json' => self::normalKit('Bone Crush', 1.7, 1, 4)],
            ['key' => 'sandstorm_titan', 'name' => 'Sandstorm Titan', 'glyph' => '💀', 'hp' => 8200, 'atk' => 430, 'gold' => 4200, 'xp' => 13500, 'gems' => 25, 'is_boss' => true, 'is_elite' => false, 'zone_id' => $zoneId('crimson_wastes'), 'min_level' => 198, 'enabled' => true, 'skills_json' => self::bossKit('Crimson Slam', 1.8, 'Bone Storm', 3, 'Desiccating Regeneration', 12)],

            // Astral Expanse [200, 250) — boss at 248 (Astral Emperor).
            ['key' => 'star_leech', 'name' => 'Star Leech', 'glyph' => '⭐', 'hp' => 6800, 'atk' => 380, 'gold' => 3300, 'xp' => 10500, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('astral_expanse'), 'min_level' => 200, 'enabled' => true, 'skills_json' => self::normalKit('Starlight Drain', 0.6, 2)],
            ['key' => 'astral_seraph', 'name' => 'Astral Seraph', 'glyph' => '🕊', 'hp' => 8200, 'atk' => 440, 'gold' => 4000, 'xp' => 12800, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('astral_expanse'), 'min_level' => 217, 'enabled' => true, 'skills_json' => self::normalKit('Radiant Smite', 1.6)],
            ['key' => 'comet_devourer', 'name' => 'Comet Devourer', 'glyph' => '☄', 'hp' => 9700, 'atk' => 500, 'gold' => 4800, 'xp' => 15500, 'gems' => 0, 'is_boss' => false, 'is_elite' => false, 'zone_id' => $zoneId('astral_expanse'), 'min_level' => 233, 'enabled' => true, 'skills_json' => self::normalKit('Comet Crash', 1.7, 1, 4)],
            ['key' => 'astral_emperor', 'name' => 'Astral Emperor', 'glyph' => '🌟', 'hp' => 13000, 'atk' => 620, 'gold' => 7200, 'xp' => 23000, 'gems' => 30, 'is_boss' => true, 'is_elite' => false, 'zone_id' => $zoneId('astral_expanse'), 'min_level' => 248, 'enabled' => true, 'skills_json' => self::bossKit('Nova Burst', 2.0, 'Stellar Barrage', 3, 'Astral Renewal', 15)],
        ];
