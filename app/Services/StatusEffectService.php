...
class StatusEffectService
{
     ...
     * — key => [label, glyph, tone, unit, desc, stacking]. `desc` is the plain-English mechanical meaning
     * shown as a tooltip on every live pill (see pillsFor()); `stacking` is a second, always-true sentence
     * about how repeated applications of THIS effect behave (durations/magnitudes vary per skill, but the
     * stacking rule per effect type doesn't) — shown in the glossary panel, not on individual pills. */
    public const CATALOG = [
        self::WEAKEN => ['label' => 'Weaken', 'glyph' => '↓⚔', 'tone' => 'orange', 'unit' => 'pct', 'desc' => "Reduces the target's outgoing damage.", 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::VULNERABLE => ['label' => 'Vulnerable', 'glyph' => '⚠', 'tone' => 'purple', 'unit' => 'pct', 'desc' => 'Increases damage the target takes from every source.', 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::ARMOR_SHRED => ['label' => 'Armor Shred', 'glyph' => '🛡↓', 'tone' => 'red', 'unit' => 'pct', 'desc' => "Reduces the target's effective Defense.", 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::CRIT_DOWN => ['label' => 'Crit Down', 'glyph' => '✦↓', 'tone' => 'gray', 'unit' => 'flat', 'desc' => "Lowers the target's crit chance (flat points).", 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::EVASION => ['label' => 'Evasion', 'glyph' => '💨', 'tone' => 'blue', 'unit' => 'flat', 'desc' => "Raises the target's dodge chance (flat points).", 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::HASTE => ['label' => 'Haste', 'glyph' => '⚡', 'tone' => 'gold', 'unit' => 'pct', 'desc' => 'Increases speed — acts sooner in the round order.', 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::SLOW => ['label' => 'Slow', 'glyph' => '🐌', 'tone' => 'gray', 'unit' => 'pct', 'desc' => 'Reduces speed — acts later in the round order.', 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::STUN => ['label' => 'Stun', 'glyph' => '💫', 'tone' => 'gold', 'unit' => 'flag', 'desc' => 'Skips this unit\'s next turn entirely, then wears off.', 'stacking' => 'Any stack present skips the next turn, then exactly one stack is consumed — extra stacks queue up further skipped turns.'],
        self::FREEZE => ['label' => 'Freeze', 'glyph' => '❄', 'tone' => 'blue', 'unit' => 'flag', 'desc' => 'Skips this unit\'s next turn entirely, then thaws.', 'stacking' => 'Mechanically identical to Stun (same skip-a-turn effect), themed for ice/cold skills — any stack present skips the next turn, then one stack is consumed.'],
        self::BURN => ['label' => 'Burn', 'glyph' => '🔥', 'tone' => 'red', 'unit' => 'flat', 'desc' => 'Flat damage at the start of each round, ignores Defense.', 'stacking' => 'Each application is its own stack, ticking down independently — a skill that says "25% of damage dealt" rolls that amount fresh every time it hits.'],
        self::POISON => ['label' => 'Poison', 'glyph' => '☠', 'tone' => 'green', 'unit' => 'flag', 'desc' => "Deals a % of the target's own max HP at the start of each round, per stack.", 'stacking' => "Stacks accumulate with every application (no per-stack timer) and the whole pool loses exactly one stack per round — more hits before it starts decaying means more rounds of damage."],
        self::SHIELD => ['label' => 'Shield', 'glyph' => '🛡', 'tone' => 'blue', 'unit' => 'flat', 'desc' => 'Absorbs the next hit(s) before HP is touched.', 'stacking' => 'Each application is its own pool, consumed oldest-first — a fresh Shield stacks on top of any that\'s left.'],
        self::TAUNT => ['label' => 'Taunt', 'glyph' => '🎯', 'tone' => 'red', 'unit' => 'flag', 'desc' => 'Enemy attacks are concentrated onto this unit instead of splitting.', 'stacking' => 'Any stack present forces every enemy attack this round; duplicate applications just refresh how long it lasts.'],
        self::BREAK => ['label' => 'Break', 'glyph' => '💥🛡', 'tone' => 'red', 'unit' => 'pct', 'desc' => "Instantly shatters the target's Shield stacks, then increases damage taken like Vulnerable.", 'stacking' => 'The shield-shatter happens once on application; the resulting damage-taken increase stacks and ticks down exactly like Vulnerable.'],
        self::MEND_OVER_TIME => ['label' => 'Regen', 'glyph' => '💚', 'tone' => 'green', 'unit' => 'flat', 'desc' => 'Flat heal at the start of each round.', 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::ATK_UP => ['label' => 'Empowered', 'glyph' => '⚔↑', 'tone' => 'gold', 'unit' => 'pct', 'desc' => "Increases the target's outgoing damage.", 'stacking' => 'Each application is its own stack, ticking down independently — magnitudes add together while stacks overlap.'],
        self::ROOT => ['label' => 'Root', 'glyph' => '🌿⛓', 'tone' => 'gray', 'unit' => 'flag', 'desc' => 'Cannot Flee the battle while rooted.', 'stacking' => 'Any stack present blocks Flee; duplicate applications just refresh how long it lasts.'],
    ];
