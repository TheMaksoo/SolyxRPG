...
class GmArtisanController extends Controller
{
    ...
    private const DANGER_LEVELS = [
        ...
        'characters:force-respec-all' => 'critical',
    ...
    public function index()
    {
        return response()->json([
            'commands' => [
                ...
                [
                    'key' => 'characters:force-respec-all',
                    'label' => 'Force Respec Everyone',
                    'description' => 'Resets EVERY character\'s skills, branch picks, and attributes (refunding all points, no gem cost). Use after a skill-tree content change breaks previously-unlocked builds.',
                    'requires_season' => false,
                    'danger_level' => 'critical',
                ],
                [
